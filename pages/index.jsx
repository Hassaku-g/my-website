      ...
      <Layout>
        <section>
          ...
          <p className="my-6">
            はじめまして、三島大地と申します。
            <br />
            このサイトでは私の経歴、手がけた作品、ブログを紹介しています。
            <br />
            ごゆっくりとご覧ください。
          </p>
          <p className="my-6">
            私はウェブ制作のスキルを身に付け、2021年9月に異業種からコーダーに転職しました。
            <br />
            学習を始めた時からウェブの技術に興味を持つようになり、積極的にスキルの習得に励んでいます。
            <br />
            最近ではフロントエンド技術の学習に取り組んでおります。
            <br />
            ウェブの構築が好きで、ゼロから作り上げたときには毎回感動を覚えます。
          </p>
          <p className="my-6">
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-3">GitHub Account</div>
            </div>
